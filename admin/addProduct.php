    ...
    <body>
        <section class="main">
            <div class="container_view">
                ...
                <h1 class="add_title"> Thêm sản phẩm mới</h1>

                <form method="post" action="sql_addProduct.php" class="add_news" enctype="multipart/form-data">

                    <span>#</span>
                    <input type="text" name="id" readonly value="RANDOM">
